...
[![godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/ask-myfi/zerolog) [![license](http://img.shields.io/badge/license-MIT-red.svg?style=flat)](https://raw.githubusercontent.com/rs/zerolog/master/LICENSE) [![Build Status](https://github.com/ask-myfi/zerolog/actions/workflows/test.yml/badge.svg)](https://github.com/ask-myfi/zerolog/actions/workflows/test.yml) [![Go Coverage](https://github.com/ask-myfi/zerolog/wiki/coverage.svg)](https://raw.githack.com/wiki/rs/zerolog/coverage.html)
...
Find out [who uses zerolog](https://github.com/ask-myfi/zerolog/wiki/Who-uses-zerolog) and add your company / project to the list.
...
```bash
go get -u github.com/ask-myfi/zerolog/log
```
...
For simple logging, import the global logger package **github.com/ask-myfi/zerolog/log**
...
import (
    ...
    "github.com/ask-myfi/zerolog/log"
)
...
The `github.com/ask-myfi/zerolog/hlog` package provides some helpers to integrate zerolog with `http.Handler`.
